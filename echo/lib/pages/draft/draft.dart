        ...
        children: [
          Row(
            //Will have to change the recentMails to recentDrafts
              ...
              Expanded(
                child: ListView.builder(shrinkWrap:true,itemCount:draftMessages.length,itemBuilder: (context,index){
      return Padding(
          ...
          Navigator.push(
              ...
              PageRouteBuilder(
                pageBuilder: (BuildContext context, Animation animation,
                  ...
                  return DraftViewPage(sender:draftMessages[index].sender.toString(),subject:draftMessages[index].subject.toString(),snippet:draftMessages[index].snippet.toString(),date:draftMessages[index].date.toString());
                },
                opaque: true,
            ...
            children: [
              ...
              Column(
                ...
                Text(
                  ...
                  draftMessages[index].sender.toString()
                  ,
                  style: TextStyle(
                ...
                Column(
                  children: [
                    Text(
                      draftMessages[index].date.toString(),
                      style: TextStyle(
                          color: Colors.black,
